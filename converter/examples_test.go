...
import (
	...
	"github.com/pubgo/protoc-gen-openapi/converter"
)
...
info:
  ...
  description: This is documentation that was generated from [protoc-gen-openapi](https://github.com/pubgo/protoc-gen-openapi).
`)))
	if err != nil {
